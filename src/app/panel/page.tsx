...
import { Eye, Users, Activity, Send, Check, X, BarChart3, Sparkles, UserCircle, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      <aside className="fixed left-0 top-0 h-screen w-60 bg-white border-r border-gray-100 p-4 flex flex-col z-40">
        ...
        <nav className="flex-1 space-y-1">
          {[{ label: 'Dashboard', href: '/dashboard', icon: Activity }, { label: 'My Personas', href: '/my-personas', icon: UserCircle }, { label: 'Persona Library', href: '/personas', icon: Users }, { label: 'Panel', href: '/panel', icon: BarChart3, active: true }, ...(isAdmin(user?.email) ? [{ label: 'Admin', href: '/admin', icon: Shield }] : [])].map((item) => (
